...
export const hrPages = [
  ...
  { id: "hr-attendance",  title: "Attendance",   path: "/hr/attendance"  },
  { id: "hr-leaves",      title: "Leaves",       path: "/hr/leaves"      },
...
export const employeePages = [
  ...
  { id: "emp-attendance", title: "Attendance",path: "/employee/attendance" },
  { id: "emp-messages",   title: "Messages",  path: "/employee/messages"   },
  { id: "emp-salary",     title: "Salary",    path: "/employee/salary"     },
