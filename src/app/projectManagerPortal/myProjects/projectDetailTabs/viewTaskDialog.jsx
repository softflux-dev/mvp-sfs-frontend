...
const ViewTaskDialog = ({ open, onClose, task = {} }) => {
  ...
  return (
    <DialogContainer open={open} onClose={onClose} maxWidth="520px" fullWidth>
      ...
      <Grid container spacing={2} mb={3}>
        <Grid item size={{ xs: 6 }}>
          <Typography fontSize="11px" color="text.secondary" fontWeight={500} mb={0.5}>Start Date</Typography>
          <Typography fontSize="14px" fontWeight={700} color="text.primary">
            {task.startDate || "-"}
          </Typography>
        </Grid>
        <Grid item size={{ xs: 6 }}>
          <Typography fontSize="11px" color="text.secondary" fontWeight={500} mb={0.5}>End Date</Typography>
          <Typography fontSize="14px" fontWeight={700} color="text.primary">
            {task.endDate || "-"}
          </Typography>
        </Grid>
